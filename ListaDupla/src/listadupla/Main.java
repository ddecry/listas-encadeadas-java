...
public class Main {
    public static void main(String[] args) {
        ...
        while (opt != 0) {
            ...
            System.out.println("5. Listar (forward)");
            System.out.println("6. Listar (backward)");
            ...
            switch (opt) {
                ...
                case 5 -> System.out.println("Lista forward: " + lista.listForward());
                case 6 -> System.out.println("Lista backward: " + lista.listBackward());
